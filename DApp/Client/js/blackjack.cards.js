  ...
  //The global options
    ...
    async function shuffle(deck) {
        ...
        */
        ...
        for( let i = 0; i < 52; i++) {
            let randIndex = randArray[i] - 1;
            console.log('RAD INDEX', randIndex);

            let tempi = deck[i];
            deck[i] = deck[randIndex];
            deck[randIndex] = tempi;
            // deck[i] = res[i];
        }
        console.log('deckky', deck);
            // all = newDeck;
            // return deck;
        // });
      }
